...
router.post('/appointments/:appointmentId/cancel', (req, res) => {
  try {
    ...
    const slotReleased = doctorModel.releaseSlot(
...
router.post('/appointments/:appointmentId/reschedule', (req, res) => {
  try {
    ...
    const availableSlots = doctorModel.getAvailableSlots(
      appointment.doctorId,
      newDate
    );
    ...
    // Release old slot
    const oldSlotReleased = doctorModel.releaseSlot(
      appointment.doctorId,
      appointment.date,
      appointment.time
    );
    ...
    // Book new slot
    const newSlotBooked = doctorModel.bookSlot(
      appointment.doctorId,
      newDate,
      newTime
    );
